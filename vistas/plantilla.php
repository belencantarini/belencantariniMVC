            ...
            <div class="container-fluid px-3 px-sm-5">
                ...
                <div class="collapse navbar-collapse show" id="navbarBasic">
                    <ul class="navbar-nav ms-auto mb-2 mb-xl-0 gap-1">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="index.php?ruta=tratamientos">Los tratamientos</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="index.php?ruta=sobremi">Sobre mi</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link purple" aria-current="page" href="index.php?ruta=contacto">Contacto</a>
                        </li>
                    </ul>
                </div>
            </div>
